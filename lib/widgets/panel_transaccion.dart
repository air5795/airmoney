...
class _PanelTransaccionState extends State<PanelTransaccion> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final bool esPlan = widget.esPlanificacion || (widget.transaccion != null && widget.transaccion!.esProgramada);
    final baseHeight = widget.transaccion != null
        ? (esPlan 
            ? (size.height * 0.70).clamp(540.0, 620.0)
            : (size.height * 0.76).clamp(580.0, 680.0))
        : (esPlan
            ? (size.height * 0.65).clamp(500.0, 580.0)
            : (size.height * 0.72).clamp(520.0, 620.0));
  ...
  void _showQuickCreateCategoryDialog(
    ...
    int dialogIconTab = _tabController.index == 1 ? 1 : 0; // Gastos o Ingresos por defecto
    
    final List<String> initialKeys = (dialogIconTab == 0)
        ? EstadoApp.expenseIconKeys.where((key) => _galleryIcons.containsKey(key)).toList()
        : EstadoApp.incomeIconKeys.where((key) => _galleryIcons.containsKey(key)).toList();
    String selectedIcon = initialKeys.contains('restaurant') ? 'restaurant' : (initialKeys.isNotEmpty ? initialKeys.first : 'category');
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Selector de icono con pestañas e iconos grandes
                      Text(
                        'SELECCIONAR ICONO',
                        style: TextStyle(
                          fontSize: 9.5,
                                      ...
                                      child: GestureDetector(
                                        ...
                                        child: Center(
                                          child: Text(
                                            ...
                                            style: TextStyle(
                                              fontSize: 13,
                                              fontWeight: dialogIconTab == 0 ? FontWeight.bold : FontWeight.w500,
                                              color: dialogIconTab == 0 ? colorTipo : colorTexto.withValues(alpha: 0.6),
                                            ),
                                          ),
                                        ),
                                      ),
                                      ...
                                      child: GestureDetector(
                                        ...
                                        child: Center(
                                          child: Text(
                                            ...
                                            style: TextStyle(
                                              fontSize: 13,
                                              fontWeight: dialogIconTab == 1 ? FontWeight.bold : FontWeight.w500,
                                              color: dialogIconTab == 1 ? colorTipo : colorTexto.withValues(alpha: 0.6),
                                            ),
                                          ),
                                        ),
                                      ),
                                      ...
                                      child: GestureDetector(
                                        ...
                                        child: Center(
                                          child: Text(
                                            ...
                                            style: TextStyle(
                                              fontSize: 13,
                                              fontWeight: dialogIconTab == 2 ? FontWeight.bold : FontWeight.w500,
                                              color: dialogIconTab == 2 ? colorTipo : colorTexto.withValues(alpha: 0.6),
                                            ),
                                          ),
                                        ),
                                      ),
                      ...
                      Container(
                        ...
                        child: Builder(
                          builder: (context) {
                            ...
                            if (dialogIconTab == 0) {
                              currentKeys = EstadoApp.expenseIconKeys.where((key) => _galleryIcons.containsKey(key)).toList();
                            } else if (dialogIconTab == 1) {
                              currentKeys = EstadoApp.incomeIconKeys.where((key) => _galleryIcons.containsKey(key)).toList();
                            } else {
                              currentKeys = _galleryIcons.keys.toList();
                            }
                      ...
                      // Color picker & Vista previa side-by-side si es padre, de lo contrario locked y heredado
                      if (selectedParentId == null) ...[
                        Text(
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: colorTipo.withValues(alpha: 0.05),
                            borderRadius: BorderRadius.circular(20),
                            border: Border.all(
  ...
  void _showParentCategorySelectorBottomSheet({
    ...
    required List<ModeloCategoria> parentCategories,
    required bool esOscuro,
    required Color colorPrincipal,
    required Color colorTexto,
    required String? currentParentId,
    required Function(ModeloCategoria?) onParentSelected,
  }) {
    showModalBottomSheet(
      context: context,
      backgroundColor: Colors.transparent,
                      ...
                      child: Column(
                        children: [
                          ...
                          ...parentCategories.map((cat) {
                            ...
                            final isSelected = currentParentId == cat.id;
  ...
  Widget _buildQuickDialogPreview({
    ...
    final hexColorStr = selectedColorHex.isEmpty ? '#E2E8F0' : selectedColorHex;
    final catColor = Color(int.parse(hexColorStr.replaceFirst('#', '0xFF')));
    final isSubcategory = selectedParentId != null;
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Center(
                child: Icon(
                  _galleryIcons[selectedIconCode] ?? Icons.bubble_chart_rounded,
                  color: catColor,
                  size: 18,
                ),
              ),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    categoryName.isEmpty ? 'Nombre' : categoryName,
                    style: TextStyle(
                      fontSize: 15,
                      fontWeight: FontWeight.bold,
                      color: colorTexto,
